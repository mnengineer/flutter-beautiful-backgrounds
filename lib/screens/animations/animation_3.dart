  ...
  List<Widget> _buildLinesSettings() {
    return <Widget>[
      ...
      Row(
        children: <Widget>[
          ElevatedButton(
            child: const Text('Next Direction'),
            onPressed: () {
              setState(() {
                _lineDirection =
  ...
  List<Widget> _buildSpaceSettings() {
    return <Widget>[
      Row(
        children: <Widget>[
          ElevatedButton(
            child: const Text('Launch Example Splash'),
            onPressed: () {
              // NOP
            },
          ),
